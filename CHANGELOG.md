...
* Remove published `postinstall` hook that referenced `scripts/postinstall.mjs`, which is not included in the npm package and caused install failures for consumers
...
[1.0.2]: https://github.com/homotechsual/docusaurus-plugin-faqs/compare/1.0.1...1.0.2
